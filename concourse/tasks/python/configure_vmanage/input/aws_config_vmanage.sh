...
vault kv get --field=ssh-key concourse/sdwan/$NAME/ssh-ed25519-private-key >> ed25519
...
REGION='us-west-2'
export REGION
#aws ec2-instance-connect send-serial-console-ssh-public-key --instance-id $INSTANCE_1_ID --serial-port 0 --ssh-public-key file://id_ed25519.pub --region $REGION
aws ec2-instance-connect send-serial-console-ssh-public-key --instance-id i-0f678cce2a4fc9ae7 --serial-port 0 --ssh-public-key file://ed25519.pub --region us-west-2
