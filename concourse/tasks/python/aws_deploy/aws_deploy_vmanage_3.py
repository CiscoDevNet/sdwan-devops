...
inst_name="vmanage-3"
eip_mgmt='eipalloc-004bc60360b872489'
eip_public='eipalloc-0536b0c038bf8ba27'
eip_cluster='eipalloc-03fbf2cb78bace28e'
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_3" + "/" + "vmanage_instance_id"
print(url)
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_3" + "/" + "public_eni_id"
print(url)
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_3" + "/" + "cluster_eni_id"
print(url)
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_3" + "/" + "vol_id"
print(url)
