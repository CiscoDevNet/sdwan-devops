...
vmanage_user_data = "./git-cisco-sdwan-devops/sdwan/tasks/python/aws_deploy/vmanage_user_data"

keypair_name=name
sg_name=name
ami_id='ami-051d5e945cdc0c366'

print("the current working directory and subdirs are....")
path = os.getcwd()
print(path)
os.listdir(path)
...
#Create the Instance
cmd_deploy_vmanage='aws ec2 run-instances --region' + " " + "{}".format(region) + " " + '--image-id' + " " + "{}".format(ami_id) + " " + '--instance-type' + " " + "{}".format(instance_type) + " " + '--subnet-id' + " " + "{}".format(subnetid_mgmt) +  " " + '--security-group-ids' + " " + "{}".format(sgid) + " " + '--key-name' + " " + "{}".format(keypair_name) + " " + '--placement AvailabilityZone=' + "{}".format(az) + " " + '--user-data file://vmanage_user_data'
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage" + "/" + "vmanage_instance_id"
print(url)
...
#data = f'{{"token": "{TOKEN}"}}'
data_json = {"vmanage_instance_id": vmanage_instance_id }
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage" + "/" + "public_eni_id"
print(url)
...
#data = f'{{"token": "{TOKEN}"}}'
data_json = {"public_eni_id": public_eni_id }
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage" + "/" + "cluster_eni_id"
print(url)
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage" + "/" + "vol_id"
print(url)
