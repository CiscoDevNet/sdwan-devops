...
vmanage_user_data = "./git-resource/sdwan/tasks/aws_deploy/vmanage_user_data"
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage" + "/" + "vmanage_instance_id"
print(url)
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage" + "/" + "public_eni_id"
print(url)
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage" + "/" + "cluster_eni_id"
print(url)
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage" + "/" + "vol_id"
print(url)
