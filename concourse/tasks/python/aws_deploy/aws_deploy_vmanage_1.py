...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_1" + "/" + "vmanage_instance_id"
print(url)
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_1" + "/" + "public_eni_id"
print(url)
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_1" + "/" + "cluster_eni_id"
print(url)
...
url = "http://http://vault.cisco-sdwan-labs.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_1" + "/" + "vol_id"
print(url)
