...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_2" + "/" + "vmanage_instance_id"
print(url)
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_2" + "/" + "public_eni_id"
print(url)
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_2" + "/" + "cluster_eni_id"
print(url)
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_2" + "/" + "vol_id"
print(url)
