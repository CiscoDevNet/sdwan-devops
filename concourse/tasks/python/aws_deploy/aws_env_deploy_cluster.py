...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "subnetid_public"
...
#Write the subnetid_mgmt to the vault
...
#Write the subnetid_cluster to the vault

url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "subnetid_cluster"
...
#data = f'{{"token": "{TOKEN}"}}'
data_json = {"subnetid_cluster": subnetid_cluster }

resp = requests.post(url, headers=headers, json=data_json)
print(resp.status_code)

#Write the igid to the vault
...
#Write rt_cluster_id to the vault
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "rt_cluster_id"
...
#data = f'{{"token": "{TOKEN}"}}'
data_json = {"rt_cluster_id": rt_cluster_id }

resp = requests.post(url, headers=headers, json=data_json)
print(resp.status_code)


#Write the SDWAN_sg_id to the vault

url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "SDWAN_sg_id"
print(url)
