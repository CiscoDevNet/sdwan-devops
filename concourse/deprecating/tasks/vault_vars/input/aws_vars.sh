...
vault kv put concourse/sdwan/$NAME/VMANAGE_INSTANCE_TYPE=$VMANAGE_INSTANCE_TYPE
export VBOND_AMI="ami-0669c73a744a9071a"
vault kv put concourse/sdwan/$NAME/VBOND_AMI=$VBOND_AMI
export VBOND_INSTANCE_TYPE="t2.medium"
vault kv put concourse/sdwan/$NAME/VBOND_INSTANCE_TYPEI=$VBOND_INSTANCE_TYPE
export VSMART_AMI="ami-0b3dcbdd1621b4819"
vault kv put concourse/sdwan/$NAME/VSMART_AMI=$VSMART_AMI
export VSMART_INSTANCE_TYPE="t2.medium"
vault kv put concourse/sdwan/$NAME/VSMART_INSTANCE_TYPE=$VSMART_INSTANCE_TYPE

# Example to generate a random password
# TODO  save it somewhere?
export VMANAGE_USERNAME="admin"
vault kv put concourse/sdwan/$NAME/VMANAGE_USERNAME=$VMANAGE_USERNAME
export VMANAGE_PASS="$(openssl rand -base64 12)"
vault kv put concourse/sdwan/$NAME/VMANAGE_PASS=$VMANAGE_PASS
export VMANAGE_ENCRYPTED_PASS="$(echo "$VMANAGE_PASS" | openssl passwd -6 -stdin)"
vault kv put concourse/sdwan/$NAME/VMANAGE_ENCRYPTED_PASSS=$VMANAGE_ENCRYPTED_PASS
export SDWAN_CA_PASSPHRASE="$(openssl rand -base64 15)"
vault kv put concourse/sdwan/$NAME/SDWAN_CA_PASSPHRASES=$SDWAN_CA_PASSPHRASE
...
vault kv put concourse/sdwan/$NAME/ACL_RANGES_IPV4_BASE64=$ACL_RANGES_IPV4_BASE64
export ACL_RANGES_IPV6_BASE64=$(echo '"::/0"' | base64)
vault kv put concourse/sdwan/$NAME/ACL_RANGES_IPV6_BASE644=$ACL_RANGES_IPV6_BASE64
...
vault kv put concourse/sdwan/$NAME/SDWAN_DATACENTER=$SDWAN_DATACENTER
...
vault kv put concourse/sdwan/$NAME/NETWORK_CIDR=$NETWORK_CIDR
export VMANAGE1_IP=10.128.1.11/24
vault kv put concourse/sdwan/$NAME/MANAGE1_IP=$MANAGE1_IP
export VBOND1_IP=10.128.1.12/24
vault kv put concourse/sdwan/$NAME/VBOND1_IP=$VBOND1_IP
export VSMART1_IP=10.128.1.13/24
vault kv put concourse/sdwan/$NAME/VSMART1_IP=$VSMART1_IP
export VPN0_GATEWAY=10.128.1.1
vault kv put concourse/sdwan/$NAME/VPN0_GATEWAY=$VPN0_GATEWAY
...
vault kv put concourse/sdwan/$NAME/HQ_EDGE1_IPY=$HQ_EDGE1_IP
export SITE1_EDGE1_IP=1.1.1.5/24
vault kv put concourse/sdwan/$NAME/SITE1_EDGE1_IPY=$SITE1_EDGE1_IP
export SITE2_EDGE1_IP=1.1.1.6/24
vault kv put concourse/sdwan/$NAME/SITE2_EDGE1_IP=$SITE2_EDGE1_IP

export IOSXE_SDWAN_IMAGE=iosxe-sdwan-16.12.5
vault kv put concourse/sdwan/$NAME/IOSXE_SDWAN_IMAGEP=$IOSXE_SDWAN_IMAGE

export VIPTELA_VERSION=20.8.1
vault kv put concourse/sdwan/$NAME/VIPTELA_VERSION=$VIPTELA_VERSION

export VMANAGE_ORG=CIDR_SDWAN_WORKSHOPS
vault kv put concourse/sdwan/$NAME/VMANAGE_ORGN=$VMANAGE_ORG

export CLOUDINIT_TYPE=v2
vault kv put concourse/sdwan/$NAME/CLOUDINIT_TYPE=$CLOUDINIT_TYPE
